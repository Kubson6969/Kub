# Diseño de clases: MMOClasses × MMOWeaponary
...
MMOWeaponary define el **arma** y MMOClasses define **quién puede usarla y cómo escala**:
...
- **PlaceholderAPI**: `%mmoclasses_clase%`, `%mmoclasses_nivel%`, `%mmoclasses_recurso%` para scoreboard y tab.
