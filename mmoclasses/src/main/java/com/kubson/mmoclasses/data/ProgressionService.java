...
import com.kubson.mmoclasses.api.event.ClassChangeEvent;
import com.kubson.mmoclasses.api.event.ClassLevelUpEvent;
...
public final class ProgressionService {
    ...
    public ProgressionService(MMOClasses plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean chooseClass(Player player, PlayerData data, PlayerClass newClass) {
        ...
        if (oldClass != null && !player.hasPermission("mmoclasses.cambiar")) {
